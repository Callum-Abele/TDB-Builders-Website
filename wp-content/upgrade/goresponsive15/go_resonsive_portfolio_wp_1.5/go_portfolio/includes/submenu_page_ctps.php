			...
			<div class="inside">
				<table class="form-table">
					...
					<tr>
						...
						<td><p class="description"><?php _e( 'URL friendly version of the custom post type (e.g. portfolio). <strong>Important: </strong>Max. 20 characters.', 'go_portfolio_textdomain' ); ?></p></td>
					</tr>
					<tr>
