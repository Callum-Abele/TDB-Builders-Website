			...
			<div class="inside">
				...
				<table class="form-table">  					
					<tr>
						...
						<td colspan="3"><p class="description"><?php _e( 'Maximum with of portfolio in tablet (landscape) view.', 'go_portfolio_textdomain' ); ?></p></td>
					</tr>
					<tr>
						...
						<td colspan="3"><p class="description"><?php _e( 'Maximum with of portfolio in mobile (landscape) view.', 'go_portfolio_textdomain' ); ?></p></td>
					</tr>					
					<tr>
						...
						<td colspan="3"><p class="description"><?php _e( 'Maximum with of portfolio in mobile (portrait) view.', 'go_portfolio_textdomain' ); ?></p></td>
					</tr>															                                                        
				</table>
