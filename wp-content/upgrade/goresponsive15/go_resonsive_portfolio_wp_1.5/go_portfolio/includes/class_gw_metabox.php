...
class GW_Meta_Box {
	...
	public function __construct( $id=NULL, $title=NULL, $fields=NULL, $post_types=NULL, $context = 'normal', $priority = 'high', $autosave = true ) {		
			...
			(function ($, undefined) {
				...
				$(function () {
					...
					$gopfMetabox.on('click', '.img-upload', function(e) {
						...
						if (wp!=undefined) {
							if ( typeof file_frame != 'undefined' ) { file_frame.close(); }
