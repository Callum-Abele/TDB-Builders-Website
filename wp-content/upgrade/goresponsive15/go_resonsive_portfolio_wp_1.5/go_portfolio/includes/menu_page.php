...
<div id="gwa-gopf-admin-wrap" class="wrap">
	...
	<form id="gwa-gopf-form" name="gwa-gopf-form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>&noheader=true">
		...
		<p class="submit">
			...
			<input type="button" class="button-secondary gwa-gopf-clone" value="<?php esc_attr_e( 'Clone', 'go_portfolio_textdomain' ); ?>" />
	...
	?>
	<!-- form -->
	<form id="gwa-gopf-form" name="gwa-gopf-form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>&noheader=true" data-ajaxerrormsg="<?php _e( 'Oops, AJAX error!', 'go_portfolio_textdomain' ); ?>">
				...
				<div class="postbox">
					...
					<div class="inside">
						<table class="form-table">
							...
							<tr>
								<th class="gwa-gopf-w150"><?php _e( 'Filter bottom space', 'go_portfolio_textdomain' ); ?></th>
				...
				<div class="postbox">
					...
					<div class="inside">
						<table class="form-table">
							...
							<tr>
								<th class="gwa-gopf-w150"><?php _e( 'Pagination top space', 'go_portfolio_textdomain' ); ?></th>
							...
							<tr class="gwa-gopf-group" data-parent="pagination-type" data-children="load-more">
								<th class="gwa-gopf-w150"><?php _e( 'Lore more button text', 'go_portfolio_textdomain' ); ?></th>
							...
							<tr class="gwa-gopf-group" data-parent="pagination-type" data-children="load-more">
								<th class="gwa-gopf-w150"><?php _e( 'Lore more button loading text', 'go_portfolio_textdomain' ); ?></th>
